...
class RollCallVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            // For your understanding: nameLabel.leadingAnchor = view.leadingAnchor + 50
            nameLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 50),
            
            // nameLabel.trailingAnchor = view.trailingAnchor - 50
            // Notice how we want to constraint nameLabel.trailingAnchor to the left of
            // view.trailingAnchor, thus the negative 50.
            nameLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -50),
            
            // Set the spacing between the buttons and the label
            ...
            // The two constraints above implicitly set the width. Now let's connect the
            // width with height so that our button will be in a square rect.
            presentButton.widthAnchor.constraint(equalTo: presentButton.heightAnchor),
            
            // Same thing for the rejectButton.
